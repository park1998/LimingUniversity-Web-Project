...
var errorImg = jQuery.acStaticCdnUrl + '/img/errorIcon.png';
var correctImg = jQuery.acStaticCdnUrl + '/img/correctIcon.png';
var scrollImgTimer = null, curImg = 1;
$('#UserName').on('blur', function () {
    imgTip($(this), errorImg, correctImg, '用户名不能为空');
});
...
$('#login_btn').click(function () {
    ...
    $.post('/Account/Login', d, function (res) {
        if (res.Status == 1) {
            $this.val('登录成功, 跳转中...');
            if (self == top) {
